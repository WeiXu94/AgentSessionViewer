...
export interface UnifiedSession {
  ...
  model?: string;
  /** How the session was created: terminal CLI, desktop app, IDE extension, or a spawned subagent. */
  variant?: 'cli' | 'desktop' | 'vscode' | 'subagent';
  /** For subagents: the id of the parent session that spawned this one. */
  parentId?: string;
